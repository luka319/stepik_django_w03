...
class Company(models.Model):
    ...
    logo = models.URLField(default='https://place-hold.it/100x60') #– Логотипчик (logo) (URLField(default='https://place-hold.it/100x60'))
    description = models.TextField() #– Информация о компании (description)
    employee_count = models.PositiveIntegerField() #– Количество сотрудников (employee_count)
...
class Speciality(models.Model):
    ...
    code = models.CharField(max_length=30) #– Код(code)    например, testing, gamedev
    title = models.CharField(max_length=130) #– Название(title)
    picture = models.URLField(default='https://place-hold.it/100x60')#– Картинка(picture)(URLField(default='https://place-hold.it/100x60'))
